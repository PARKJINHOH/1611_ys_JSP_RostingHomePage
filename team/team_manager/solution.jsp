...
<%
    ...
    try { 
       ...
       strSql = "select * from qaboard order by id desc ";
...
%>
            <tr class=list bordercolor=#f3f3f3
               ...
               <td width=340>
                   <A href="solshow.jsp?id=<%=rs.getInt("id")%>"><%=rs.getString("title")%></a>
               </td>
...
<div><br><br> [<A align=right href="solwriteform.jsp">게시판에 글쓰기</A>] </div>
