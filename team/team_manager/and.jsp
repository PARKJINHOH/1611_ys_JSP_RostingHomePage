				...
				<div class="right" id="fixed" align="center">
					<div class="home-text">
						<div
							...
							<h1 class="hs-line-15 font-alt mb-50 mb-xs-30">Android
								Application</h1>
							<h3>Chart Presentation 개발</h3>
							<img src="images/picture/and1.JPG" />
							<h3>
								</br>LGU+ HDTV Service 개발
							</h3>
							<img src="images/picture/and2.JPG" />
							<h3>
								</br>Finance SNS Application 개발
							</h3>
							<img src="images/picture/and3.JPG" />
						</div>
					</div>
				</div>
			</div>
