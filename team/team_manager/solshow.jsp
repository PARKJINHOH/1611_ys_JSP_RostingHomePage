...
<%
    ...
    // 읽은 횟수 하나 증가
       strSql = "update qaboard set hit = hit + 1 where id = " + strId; 
       intResult = stmt.executeUpdate(strSql);
		
    // 게시물 내용 읽어오기 
       stmt = conn.createStatement();
       strSql = "select * from qaboard "; 
...
[<A href="solupdate.jsp?id=<%=strId%>&mode=show">글수정</A>]
[<A href="soldelete.jsp?id=<%=strId%>">글삭제</A>]
