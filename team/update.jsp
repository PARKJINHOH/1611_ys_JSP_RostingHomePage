    ...
    try { 
       ...
       conn = DriverManager.getConnection(strConnect,"root", "1234"); 
        ...
        if (strMode.equals("update"))
        {
           ...
           // 게시판으로 돌아가기
           response.sendRedirect("smart_car.jsp");
        }
        else
        {       
           // 게시물 내용 읽어오기 
...
%>
              ...
              <FORM action="update.jsp?id=<%=strId%>&mode=update" method="post">
	...
	<input type="button" value="게시판돌아가기" onclick="location.href='smart_car.jsp'">
                     </td>
                  </tr>
                </table>
              </FORM>
