...
<%
    String strId, strRefId, strLev, strPos;
    ...
    if (request.getParameter("lev") == null)
       strLev = "";
    else
       strLev = request.getParameter("lev");
...
%>
        ...
        <input name="refid" type="hidden" value="<%=strRefId%>">
        <input name="lev" type="hidden" value="<%=strLev%>">
        <input name="pos" type="hidden" value="<%=strPos%>">
